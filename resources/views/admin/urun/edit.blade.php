            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mt-1 mr-1">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.urun.edit.post',['id'=> $data[0]['UrunID']])}}" method="POST">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="number" min="0.00" step="0.20" value="{{$data[0]['UrunFiyati']}}" name="UrunFiyati" class="form-control" placeholder="Urun" id="urunfiyatiLabel" >
