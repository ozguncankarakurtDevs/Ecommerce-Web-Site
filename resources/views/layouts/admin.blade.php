...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="{{asset('admin_css/assets/images/backgrounds/02.jpg')}}">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href="{{route('admin.resim.create')}}"><i class="ft-log-in"></i><span class="menu-title" data-i18n="">Resim Ekle</span></a></li>
            ...
            <li class=" nav-item"><a href="{{route('admin.resim.index')}}"><i class="ft-list"></i><span class="menu-title" data-i18n="">Resim Tablosu</span></a></li>
        </ul>
    </div>
